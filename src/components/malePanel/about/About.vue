<template>
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 my-10" id="about">
      <img
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0 text-center">
          <h2 class="text-4xl font-bold tracking-tight text-goldColor sm:text-6xl">
            About Us
          </h2>
        ...
        <!-- <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none text-center">
          ...
          <dl
            class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4 text-center"
          >
            <div
              v-for="stat in stats"
              :key="stat.name"
