                    ...
                    <div
                        ...
                        <div class="">
                            <img alt="ecommerce"
                                ...
                                :src="GroomingData[0]?.img" />
                        </div>
                        <div>
                            <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">
                                {{ GroomingData[0]?.title }}
                            </h1>
                            <p class="leading-relaxed mb-4">{{ GroomingData[0]?.description }}</p>
                            <div class="w-full">
                                    ...
                                    <thead class="bg-gray-800 text-white">
                                        <tr class="border-b border-gray-300">
                                            ...
                                            <th class="py-2 px-4 text-center">
                                                <h4 class="text-white">Price Rs {{ GroomingData[0].price }}</h4>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr class="cursor-pointer hover:bg-gray-50"
                                            v-for="item in GroomingData[1].TwoDayData" :key="item.id">
                                ...
                                <table class="w-full border-collapse bg-gray-100 text-left">
                                    <thead class="bg-gray-800 text-white">
                                        <tr class="border-b border-gray-300">
                                            ...
                                            <th class="py-2 px-4 text-center">
                                                <h4 class="text-white">Price Rs {{ GroomingData[2].price }}</h4>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr class="cursor-pointer hover:bg-gray-50"
                                            v-for="item in GroomingData[2].ThreeDayyData" :key="item.id">
                                            <td class="py-2 px-4">{{ item.name }}</td>
                                            <td class="py-2 px-4 text-center">
                                                ---------
                                            </td>
                                ...
                                <table class="w-full border-collapse bg-gray-100 text-left">
                                    <thead class="bg-gray-800 text-white">
                                        <tr class="border-b border-gray-300">
                                            ...
                                            <th class="py-2 px-4 text-center">
                                                <h4 class="text-white">Price Rs {{ GroomingData[3].price }}</h4>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr class="cursor-pointer hover:bg-gray-50"
                                            v-for="item in GroomingData[3].FourDayData" :key="item.id">
                                            <td class="py-2 px-4">{{ item.name }}</td>
                                            <td class="py-2 px-4 text-center">
                                                ---------
                                            </td>
