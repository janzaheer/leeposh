    ...
    <div>
        <section class="text-gray-600 body-font relative my-6" id="contact">
            <div class="text-center">
                ...
                <p class="leading-relaxed my-6 text-goldColor">have a question? Let us know.</p>
            </div>
            ...
            <div class="container px-5 p-10 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    ...
                    <button
                        class="text-white bg-goldColor border-0 py-2 px-6 focus:outline-none hover:bg-goldHoverColor rounded text-lg">Button</button>
