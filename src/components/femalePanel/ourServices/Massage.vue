<template>
          ...
          >
            ...
            <div class="mt-4 grid grid-cols-1 gap-x-4 gap-y-5 sm:grid-cols-1 md:grid-cols-2 md:gap-x-2 lg:grid-cols-2 xl:gap-x-14">
              ...
              <div>
                ...
                <p class="leading-relaxed mb-4">{{ MassageData[0].description }}</p>
                <div class="w-full">
                  <table class="w-full border-collapse bg-gray-100 text-left">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                      <tr
                        ...
                        v-for="item in MassageData[0]?.MassageBodyData"
                        :key="item.id"
                      >
  ...
  <script>
  import { MassageData } from '@/db/female-db'
