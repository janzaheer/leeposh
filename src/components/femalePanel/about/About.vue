    ...
    <section id="about" class="text-gray-600 body-font">
        <div class="container px-5 py-4 mx-auto">
          <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            ...
            <h1 class="text-4xl text-goldColor mb-10">About Us</h1>
            <p class="leading-relaxed text-lg text-pinkColor">
                Welcome to Leeposh Beauty Salon
            </p>
            <p class="leading-relaxed text-lg">
                Salons where "me time" is your deserving opulence.
            </p>
            <p class="leading-relaxed text-lg">
